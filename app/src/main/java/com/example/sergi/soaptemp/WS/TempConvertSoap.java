...
public class TempConvertSoap
{
    ...
    public TempConvertSoap(){}

    public TempConvertSoap(IServiceEvents callback)
    {
        this.callback = callback;
    }
    public TempConvertSoap(IServiceEvents callback, String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public TempConvertSoap(IServiceEvents callback, String url, int timeOut)
    {
        this.callback = callback;
        this.url = url;
